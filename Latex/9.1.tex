...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.75\columnwidth]{three.jpg}
\end{center}
\caption{}
\label{fig:Figure 1}
\end{figure}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.25\columnwidth]{four.jpg}
\caption{}
\label{fig:Figure 2}
\end{center}
\end{figure}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.25\columnwidth]{five.jpg}
\end{center}
\caption{}
\label{fig:Figure 3}
\end{figure}
...
\end{enumerate}
\item $ABCD$ is a trapezium with parallel sides $AB = a cm$ and $DC = b cm$ (Figure \eqref{fig:Figure 4}). E and F are the mid-points of the non-parallel sides. The ratio of $ar (ABFE)$ and $ar (EFCD)$ is
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.25\columnwidth]{six.jpg}
\end{center}
\caption{}
\label{fig: Figure 4}
\end{figure}
