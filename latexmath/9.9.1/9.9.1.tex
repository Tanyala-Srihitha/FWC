...
\end{enumerate}
\item In which of the following figures (Figure \ref{fig:Figure 1}), you find two polygons on the same base and between the same parallels?
\begin{figure}[!h]
\begin{center}
\includegraphics[width=\columnwidth]{figs/three.jpg}
\end{center}
\caption{}
\label{fig:Figure 1}
\end{figure}
...
\end{enumerate}
\item $ABCD$ is a trapezium with parallel sides $AB = a cm$ and $DC = b cm$ (Figure \ref{fig:Figure 4}). E and F are the mid-points of the non-parallel sides. The ratio of $ar (ABFE)$ and $ar (EFCD)$ is
\begin{figure}[!h]
\begin{center}
